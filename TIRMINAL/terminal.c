...
void getTransactionDateTest(void)
{
    ...
    printf("Tester Name: Mai Farahat\n");
    printf("Function name: getTransactionDate\n");
    printf("Test Case 3: Wrong month\n");
...
{
    ST_cardData_t cardData1 = { "maielsayedfarahatnasr","123456789012345567","07/20" };
    ST_cardData_t cardData2 = { "maielsayedfarahatnasr","123456789012345688","11/27" };
    ST_terminalData_t termData;
    getTransactionDate(&termData);
    //ST_terminalData_t termdata;
...
EN_terminalError_t getTransactionAmount(ST_terminalData_t* termData)
{
    ...
    printf("Please put your Transaction amount :) ");
