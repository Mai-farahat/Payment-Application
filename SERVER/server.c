...
EN_transState_t recieveTransactionData(ST_transaction_t* transData) {
	...
	else if (isAmountAvailable(&transData->terminalData.transAmount, &accountsDB[User_Acc]) == LOW_BALANCE)
	{
	...
	else if (isBlockedAccount(&accountsDB[User_Acc]) == BLOCKED_ACCOUNT)
	{
	...
	{
		accountsDB[User_Acc].balance -= transData->terminalData.transAmount;
		printf("The new Balance is: %f \n", accountsDB[User_Acc].balance);
...
void recieveTransactionDataTest(void)
{
	...
	printf("------------------------------------------------------\n");
	printf("Tester Name: Mai Farahat\n");
	printf("Function name: recieveTransactionData\n");
	printf("Test Case 1:Fraud card (WRONG PAN)\n");

	transData = (ST_transaction_t){ .cardHolderData = "maielsayedfarahatnasr ","12345678909876542","10/26",.terminalData = {150,1500,"30/9/2022"} };
	...
	transData = (ST_transaction_t){ .cardHolderData = "maielsayedfarahatnasr ","5807007076043875","10/26",.terminalData = {150,1500,"30/9/2022"} };
	...
	transData = (ST_transaction_t){ .cardHolderData = "maielsayedfarahatnasr ","1234567890123459","10/26",.terminalData = {900,1500,"30/9/2022"} };
	...
	transData = (ST_transaction_t){ .cardHolderData = "maielsayedfarahatnasr ","1234567890123459","10/26",.terminalData = {100,1500,"30/9/2022"} };
...
{
	accountRefrence = &accountsDB[User_Acc];
...
void isValidAccountTest(void)
{
	...
	cardData = (ST_cardData_t){ .cardHolderName = "maielsayedfarahatnasr ",.primaryAccountNumber = "1236541265474145",.cardExpirationDate = "10/26" };
	...
	cardData = (ST_cardData_t){ .cardHolderName = "maielsayedfarahatnasr ",.primaryAccountNumber = "1234567890123452",.cardExpirationDate = "10/26" };
...
void isAmountAvailableTest(void)
{
	...
	termData = (ST_terminalData_t){ .transAmount = 500000,.maxTransAmount = 300000,.transactionDate = "20/06/2023" };
	...
	termData = (ST_terminalData_t){ .transAmount = 1000,.maxTransAmount = 1500,.transactionDate = "20/06/2023" };
...
void saveTransactionTest(void)
{
	...
	transData = (ST_transaction_t){ .cardHolderData = {.cardHolderName = "maielsayedfarahatnasr",.cardExpirationDate = "10/27",.primaryAccountNumber = "1234567890123456"}
	 ,.terminalData = {.maxTransAmount = 1500,.transactionDate = "21/8/2022",.transAmount = 550}
	 ,.transState = APPROVED
	};
	...
	{ .cardHolderData = {.cardHolderName = "maielsayedfarahatnasr",.cardExpirationDate = "10/27",.primaryAccountNumber = "1234567890123450"}
	 ,.terminalData = {.maxTransAmount = 1500,.transactionDate = "21/8/2022",.transAmount = 550}
...
/*void listSavedTransactionsTest(void)
{
	...
	printf("Test Case 1:BLOCKED ACCOUNT\n");
	transData = (ST_transaction_t)
	{ .cardHolderData = {.cardHolderName = "maielsayedfarahatnasr",.cardExpirationDate = "10/27",.primaryAccountNumber = "1234567890123456"}
	 ,.terminalData = {.maxTransAmount = 1500,.transactionDate = "21/8/2022",.transAmount = 550}
	 ,.transState = DECLINED_STOLEN_CARD
	};
	printf("Input Data: accountsDB[2]\n");
